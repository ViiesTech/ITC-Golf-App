...
const DropDownPicker = ({ text, label1, label2, label3, label4, label5, label6, value4, value5, value6, textStyle, style, itemStyle, labelStyle, value1, value2, value3, onValueChange, selectedValue }) => {
