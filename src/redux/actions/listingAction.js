...
export const createListing = (location, description, suggested_day, suggested_time, how_many_players, area_code, itc_handshake, desired_tee, drinking_friendly, private_listing) => {
    return async dispatch => {
        ...
        await axios.post(`${URL}/create_match`, payload, {
            headers: {
